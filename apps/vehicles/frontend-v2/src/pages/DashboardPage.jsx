...
const FORECAST_MONTH_COLORS = ['#2563eb', '#16a34a', '#eab308', '#dc2626', '#9333ea', '#0891b2', '#65a30d', '#ea580c', '#db2777', '#64748b', '#92400e', '#4f46e5'];
...
function FleetForecastCard({ data, months, selectedTypes, typeOptions, onMonthsChange, onTypeToggle, onTypeClear, loading, refreshing, onRefresh, onSegmentSelect }) {
  ...
  return (
    <article className="info-card dashboard-forecast-card">
      ...
      {updatedAt ? (
        <p className={`dashboard-forecast-updated${isStale ? ' is-stale' : ''}`}>
          Aktualizováno: <strong>{updatedAtLabel}</strong>
        </p>
      ) : null}
  ...
  return (
    <section>
      <div className="dashboard-global-head">
        <div className="dashboard-global-title">
