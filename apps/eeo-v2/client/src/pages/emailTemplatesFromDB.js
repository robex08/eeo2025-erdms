// =================================================================================
// EMAIL ŠABLONY Z DB - order_status_ke_schvaleni
// =================================================================================
// Zdroj: MySQL eeo2025.25_notification_templates
// Načteno: 7.12.2025
// 3 varianty: APPROVER_NORMAL (oranžová), APPROVER_URGENT (červená), SUBMITTER (zelená)
// Placeholders: {order_number}, {predmet}, {strediska}, {financovani}, 
//               {financovani_poznamka}, {amount}, {date}, {approver_name}, 
//               {user_name}, {order_id}
// =================================================================================

export const DB_TEMPLATE_APPROVER_NORMAL = `<!DOCTYPE html>
<html lang="cs">
<head>
    <meta charset="UTF-8">
...
export const DB_TEMPLATE_APPROVER_URGENT = `<!DOCTYPE html>
<html lang="cs">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
export const DB_TEMPLATE_SUBMITTER = `<!DOCTYPE html>
<html lang="cs">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
