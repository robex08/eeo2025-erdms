...
const Invoices25List = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      if (columnFilters.datum_doruceni && columnFilters.datum_doruceni.trim()) {
      ...
      if (columnFilters.datum_vystaveni && columnFilters.datum_vystaveni.trim()) {
        apiParams.filter_datum_vystaveni = columnFilters.datum_vystaveni.trim();
      }
      
      // Datum splatnosti (přesná shoda)
      if (columnFilters.datum_splatnosti && columnFilters.datum_splatnosti.trim()) {
