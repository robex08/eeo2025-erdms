...
export default function MoznostiZastupovaniTab() {
  ...
  const handleEdit = (rule) => {
    ...
    const zastupovanyExists = users.some(u => u.id === rule.zastupovany_id);
    if (!zastupovanyExists && rule.zastupovany_id) {
    ...
    setFormData({
      zastupovany_id: rule.zastupovany_id.toString(),
      typ_zastupce: rule.typ_zastupce,
