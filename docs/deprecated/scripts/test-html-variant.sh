...
mysql -h10.3.172.11 -uerdms_user -pCHANGE_ME_DB_PASSWORD eeo2025-dev -e "
...
echo "2. Get order ID..."
ORDER_ID=$(mysql -h10.3.172.11 -uerdms_user -pCHANGE_ME_DB_PASSWORD eeo2025-dev -se "SELECT MAX(id) FROM 25a_objednavky WHERE predmet='TEST HTML VARIANT';")
