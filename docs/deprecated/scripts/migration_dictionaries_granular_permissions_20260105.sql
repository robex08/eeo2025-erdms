-- =============================================================================
-- MIGRATION: Granular Permissions for Dictionaries
-- =============================================================================
-- Date: 2026-01-05
-- Author: System
...
--
-- FÁZE NASAZENÍ:
-- 1. FÁZE 1: Import do DEV databáze (eeo2025-dev) - TEST
-- 2. FÁZE 2: Pokud OK, import do PROD databáze (eeo2025)
-- 3. FÁZE 3: Úprava kódu na DEV a testování
-- 4. FÁZE 4: Večerní deploy na produkci
-- =============================================================================
...
SELECT 
  'Nově přidaná práva pro číselníky:' AS info;
...
FROM `25_prava`
WHERE kod_prava LIKE '%_VIEW' 
   OR kod_prava LIKE '%_CREATE' 
   OR kod_prava LIKE '%_EDIT' 
   OR kod_prava LIKE '%_DELETE'
   AND kod_prava NOT LIKE 'CASH_BOOK_%';
