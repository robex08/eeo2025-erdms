-- =============================================================================
-- 💰 ROČNÍ POPLATKY - AKTUALIZACE V1.1 (PRODUKCE)
-- =============================================================================
-- Databáze: eeo2025
-- Datum: 2026-01-30
-- Verze: 1.1.0
...
-- 3. Naplánovat údržbové okno
-- 4. Notifikovat uživatele
--
-- ZMĚNY:
...
-- =============================================================================
-- ✅ AKTUALIZACE DOKONČENA - PRODUKCE
-- =============================================================================
-- Provedeno:
...
-- 2. Ověřit funkčnost nahrávání příloh
-- 3. Testovat CRUD operace s poznámkami
-- =============================================================================
