...
mysql -h 10.3.172.11 -u erdms_user -pCHANGE_ME_DB_PASSWORD eeo2025 -e "SELECT * FROM debug_notification_log ORDER BY id DESC LIMIT 20;"

# 4. Verify notification was created:
mysql -h 10.3.172.11 -u erdms_user -pCHANGE_ME_DB_PASSWORD eeo2025 -e "SELECT id, typ, nadpis, od_uzivatele_id, pro_uzivatele_id, priorita, dt_created FROM 25_notifikace ORDER BY id DESC LIMIT 5;"
```
