...
-- Popis: HTML email šablona s DVĚMA variantami (příkazce + autor)
-- Formát: Obě HTML šablony oddělené <!-- RECIPIENT: APPROVER --> a <!-- RECIPIENT: SUBMITTER -->
-- Poznámka: app_title a app_message (zvoneček) zůstávají beze změny

USE eeo2025;

-- Aktualizace email předmětu a těla (HTML šablona s 2 variantami)
