  ...
  async getUsers(limit = 2000) {
    ...
    try {
      ...
      let response = await this.client
        .api('/users')
        .select('id,userPrincipalName,displayName,givenName,surname,mail,jobTitle,department,officeLocation,accountEnabled,createdDateTime,employeeHireDate,signInActivity')
        .top(999)
        .orderby('displayName')
